Namespace DataElements
    ...
    Partial Friend Class Element1321
        ...
        Friend Shared Function FromReader(fullElement As String, reader As EdiReader.SegmentReader) As Element1321
            Dim rval As New Element1321
