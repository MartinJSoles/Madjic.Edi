Namespace Factory.Transaction270_B1
    ...
    Public NotInheritable Class Loop2100CFactory
        ...
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_01.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI01() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_01.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_02.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI02() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_02.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_03.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI03() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_03.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_04.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI04() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_04.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_05.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI05() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_05.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_06.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI06() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_06.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_07.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI07() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_07.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_08.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI08() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_08.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
    End Class
    ...
    Public NotInheritable Class Loop2110CFactory
        ...
        Public Shared Function CreateDTP() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.DTP
            Return New Global.Madjic.Edi.Dom.Segments.DTP_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2110C.EQ.EQ_02.C003" /> interface (Composite Medical Procedure Identifier).</summary>
        Public Shared Function CreateEQ02() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2110C.EQ.EQ_02.C003
        ...
        Public Shared Function CreateEQ05() As Global.Madjic.Edi.Dom.DataElements.Composite.C004
    ...
    Public NotInheritable Class Loop2100DFactory
        ...
        Public Shared Function CreateDTP() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.DTP
            Return New Global.Madjic.Edi.Dom.Segments.DTP_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_01.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI01() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_01.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_02.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI02() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_02.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_03.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI03() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_03.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_04.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI04() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_04.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_05.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI05() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_05.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_06.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI06() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_06.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_07.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI07() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_07.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_08.C022" /> interface (Health Care Code Information).</summary>
        Public Shared Function CreateHI08() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_08.C022
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C022_Obj
        End Function
    End Class
    ...
    Public NotInheritable Class Loop2110DFactory
        ...
        Public Shared Function CreateDTP() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.DTP
            Return New Global.Madjic.Edi.Dom.Segments.DTP_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2110D.EQ.EQ_02.C003" /> interface (Composite Medical Procedure Identifier).</summary>
        Public Shared Function CreateEQ02() As Global.Madjic.Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2110D.EQ.EQ_02.C003
            Return New Global.Madjic.Edi.Dom.DataElements.Composite.C003_Obj
        End Function
        '''<summary>Creates an object that implements the <see cref="Global.Madjic.Edi.Dom.DataElements.Composite.C004" /> interface (Composite Diagnosis Code Pointer).</summary>
        Public Shared Function CreateEQ05() As Global.Madjic.Edi.Dom.DataElements.Composite.C004
