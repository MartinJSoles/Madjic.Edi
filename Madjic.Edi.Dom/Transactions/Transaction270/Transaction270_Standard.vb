Namespace Transactions
	Namespace Transaction270
		...
		Partial Friend Class Standard_Obj
			...
			Private Property ST_Std As Dom.Segments.ST Implements Standard.ST
				Get
					Return CType(Children(0), Dom.Segments.ST_Obj)
				End Get
			...
			Private Property BHT_Std As Dom.Segments.BHT Implements Standard.BHT
				Get
					Return CType(Children(1), Dom.Segments.BHT_Obj)
				End Get
			...
			Private Property SE_Std As Dom.Segments.SE Implements Standard.SE
				Get
					Return CType(Children(3), Dom.Segments.SE_Obj)
				End Get
		...
		Partial Friend Class Loop2000_Obj
			...
			Private Property HL_Std As Dom.Segments.HL Implements Loops.Loop2000.HL
				Get
					Return CType(Children(0), Dom.Segments.HL_Obj)
				End Get
			...
			Private Property HL_IFace_3_Loop2000D_Obj As Transaction270_B1.Segments.Loop2000D.HL Implements Transaction270_B1.Loops.Loop2000D.HL
				...
				End Set
			End Property
			Friend ReadOnly Property TRN_Obj As SegmentContainer(Of Dom.Segments.TRN) Implements Loops.Loop2000.TRN
				Get
					Return CType(Children(1), SegmentContainer(Of Dom.Segments.TRN))
				End Get
			End Property

			Private TRNSubset_Loop2000C_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2000C.TRN, Dom.Segments.TRN)
			Private ReadOnly Property TRN_Loop2000C_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2000C.TRN, Dom.Segments.TRN) Implements Transaction270_B1.Loops.Loop2000C.TRN
				Get
					If TRNSubset_Loop2000C_Obj Is Nothing Then
						TRNSubset_Loop2000C_Obj = New SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2000C.TRN, Dom.Segments.TRN)(Children(1), 2, 4, 72)
					End If

					Return TRNSubset_Loop2000C_Obj
				End Get
			End Property
			Private TRNSubset_1_Loop2000D_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2000D.TRN, Dom.Segments.TRN)
			Private ReadOnly Property TRN_Loop2000D_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2000D.TRN, Dom.Segments.TRN) Implements Transaction270_B1.Loops.Loop2000D.TRN
				Get
					If TRNSubset_1_Loop2000D_Obj Is Nothing Then
						TRNSubset_1_Loop2000D_Obj = New SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2000D.TRN, Dom.Segments.TRN)(Children(1), 2, 5, 72)
					End If
		...
		Partial Friend Class Loop2100_Obj
			...
			Friend Sub New()
				...
				Children.AddRange({CType(Nothing, Dom.Segments.NM1_Obj),
																	...
																	New SegmentContainer(Of Dom.Segments.MPI)(9, 2, 1250),
			...
			Private Property NM1_Std As Dom.Segments.NM1 Implements Loops.Loop2100.NM1
				Get
					Return CType(Children(0), Dom.Segments.NM1_Obj)
				End Get
			...
			Private Property NM1_IFace_3_Loop2100D_Obj As Transaction270_B1.Segments.Loop2100D.NM1 Implements Transaction270_B1.Loops.Loop2100D.NM1
				...
				End Set
			End Property
			Friend ReadOnly Property REF_Obj As SegmentContainer(Of Dom.Segments.REF) Implements Loops.Loop2100.REF
				Get
					Return CType(Children(1), SegmentContainer(Of Dom.Segments.REF))
				End Get
			End Property

			Private REFSubset_Loop2100B_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100B.REF, Dom.Segments.REF)
			Private ReadOnly Property REF_Loop2100B_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100B.REF, Dom.Segments.REF) Implements Transaction270_B1.Loops.Loop2100B.REF
				Get
					If REFSubset_Loop2100B_Obj Is Nothing Then
						REFSubset_Loop2100B_Obj = New SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100B.REF, Dom.Segments.REF)(Children(1), 9, 3, 144)
					End If

					Return REFSubset_Loop2100B_Obj
				End Get
			End Property
			Private REFSubset_1_Loop2100C_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100C.REF, Dom.Segments.REF)
			Private ReadOnly Property REF_Loop2100C_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100C.REF, Dom.Segments.REF) Implements Transaction270_B1.Loops.Loop2100C.REF
				Get
					If REFSubset_1_Loop2100C_Obj Is Nothing Then
						REFSubset_1_Loop2100C_Obj = New SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100C.REF, Dom.Segments.REF)(Children(1), 9, 4, 144)
					End If

					Return REFSubset_1_Loop2100C_Obj
				End Get
			End Property
			Private REFSubset_2_Loop2100D_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100D.REF, Dom.Segments.REF)
			Private ReadOnly Property REF_Loop2100D_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100D.REF, Dom.Segments.REF) Implements Transaction270_B1.Loops.Loop2100D.REF
				Get
					If REFSubset_2_Loop2100D_Obj Is Nothing Then
						REFSubset_2_Loop2100D_Obj = New SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100D.REF, Dom.Segments.REF)(Children(1), 9, 5, 144)
					End If
			...
			Private Property N2_Std As Dom.Segments.N2 Implements Loops.Loop2100.N2
				Get
					Return CType(Children(2), Dom.Segments.N2_Obj)
				End Get
			...
			Private Property N3_Std As Dom.Segments.N3 Implements Loops.Loop2100.N3
				Get
					Return CType(Children(3), Dom.Segments.N3_Obj)
				End Get
			...
			Private Property N4_Std As Dom.Segments.N4 Implements Loops.Loop2100.N4
				Get
					Return CType(Children(4), Dom.Segments.N4_Obj)
				End Get
			...
			Private Property N4_IFace_2_Loop2100D_Obj As Transaction270_B1.Segments.Loop2100D.N4 Implements Transaction270_B1.Loops.Loop2100D.N4
				...
				End Set
			End Property
			Friend ReadOnly Property PER_Obj As SegmentContainer(Of Dom.Segments.PER) Implements Loops.Loop2100.PER
				Get
			...
			Friend Property PRV_Obj As Dom.Segments.PRV_Obj
				Get
					Return CType(Children(6), Dom.Segments.PRV_Obj)
				End Get
			...
			Private Property PRV_Std As Dom.Segments.PRV Implements Loops.Loop2100.PRV
				Get
					Return CType(Children(6), Dom.Segments.PRV_Obj)
				End Get
			...
			Friend Property DMG_Obj As Dom.Segments.DMG_Obj
				Get
					Return CType(Children(7), Dom.Segments.DMG_Obj)
				End Get
			...
			Private Property DMG_Std As Dom.Segments.DMG Implements Loops.Loop2100.DMG
				Get
					Return CType(Children(7), Dom.Segments.DMG_Obj)
				End Get
			...
			Friend Property INS_Obj As Dom.Segments.INS_Obj
				Get
					Return CType(Children(8), Dom.Segments.INS_Obj)
				End Get
			...
			Private Property INS_Std As Dom.Segments.INS Implements Loops.Loop2100.INS
				Get
					Return CType(Children(8), Dom.Segments.INS_Obj)
				End Get
			...
			Friend Property HI_Obj As Dom.Segments.HI_Obj
				Get
					Return CType(Children(9), Dom.Segments.HI_Obj)
				End Get
			...
			Private Property HI_Std As Dom.Segments.HI Implements Loops.Loop2100.HI
				Get
					Return CType(Children(9), Dom.Segments.HI_Obj)
				End Get
			...
			Private Property HI_IFace_1_Loop2100D_Obj As Transaction270_B1.Segments.Loop2100D.HI Implements Transaction270_B1.Loops.Loop2100D.HI
				...
				End Set
			End Property
			Friend ReadOnly Property DTP_Obj As SegmentContainer(Of Dom.Segments.DTP) Implements Loops.Loop2100.DTP
				Get
					Return CType(Children(10), SegmentContainer(Of Dom.Segments.DTP))
				End Get
			End Property

			Private DTPSubset_Loop2100C_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100C.DTP, Dom.Segments.DTP)
			Private ReadOnly Property DTP_Loop2100C_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100C.DTP, Dom.Segments.DTP) Implements Transaction270_B1.Loops.Loop2100C.DTP
				Get
					If DTPSubset_Loop2100C_Obj Is Nothing Then
						DTPSubset_Loop2100C_Obj = New SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100C.DTP, Dom.Segments.DTP)(Children(10), 2, 4, 73)
					End If

					Return DTPSubset_Loop2100C_Obj
				End Get
			End Property
			Private DTPSubset_1_Loop2100D_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100D.DTP, Dom.Segments.DTP)
			Private ReadOnly Property DTP_Loop2100D_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100D.DTP, Dom.Segments.DTP) Implements Transaction270_B1.Loops.Loop2100D.DTP
				Get
					If DTPSubset_1_Loop2100D_Obj Is Nothing Then
						DTPSubset_1_Loop2100D_Obj = New SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100D.DTP, Dom.Segments.DTP)(Children(10), 2, 5, 73)
					End If

					Return DTPSubset_1_Loop2100D_Obj
				End Get
			End Property
			Friend ReadOnly Property MPI_Obj As SegmentContainer(Of Dom.Segments.MPI) Implements Loops.Loop2100.MPI
				Get
					Return CType(Children(11), SegmentContainer(Of Dom.Segments.MPI))
				End Get
			End Property
		...
		Partial Friend Class Loop2110_Obj
			...
			Friend Sub New()
				...
				Children.AddRange({CType(Nothing, Dom.Segments.EQ_Obj),
																	New SegmentContainer(Of Dom.Segments.AMT)(2, 2, 1350),
																	CType(Nothing, Dom.Segments.VEH_Obj),
																	CType(Nothing, Dom.Segments.PDR_Obj),
																	CType(Nothing, Dom.Segments.PDP_Obj),
																	New SegmentContainer(Of Dom.Segments.III)(10, 2, 1700),
																	CType(Nothing, Dom.Segments.REF_Obj),
																	New SegmentContainer(Of Dom.Segments.DTP)(9, 2, 2000)})
			...
			Private Sub PopulateSegment(ByVal args As ReaderArgs)
				...
				If String.Compare(SegmentName, "EQ", StringComparison.OrdinalIgnoreCase) = 0 Then
					Seg = Dom.Segments.EQ_Obj.FromGenericSegment(args.DataSegment, args.Reader.Reader)
					EQ_Obj = Seg
			...
			End Function
			Friend Property EQ_Obj As Dom.Segments.EQ_Obj
				Get
					Return CType(Children(0), Dom.Segments.EQ_Obj)
				End Get
				Set(value As Dom.Segments.EQ_Obj)
					Children(0) = value
				End Set
			End Property

			Private Property EQ_Std As Dom.Segments.EQ Implements Loops.Loop2110.EQ
				Get
					Return CType(Children(0), Dom.Segments.EQ_Obj)
				End Get
				Set(value As Dom.Segments.EQ)
					Children(0) = value
				End Set
			End Property
			...
			Private Property EQ_IFace_1_Loop2110D_Obj As Transaction270_B1.Segments.Loop2110D.EQ Implements Transaction270_B1.Loops.Loop2110D.EQ
				...
				End Set
			End Property
			Friend ReadOnly Property AMT_Obj As SegmentContainer(Of Dom.Segments.AMT) Implements Loops.Loop2110.AMT
				Get
					Return CType(Children(1), SegmentContainer(Of Dom.Segments.AMT))
				End Get
			End Property

			Private AMTSubset_Loop2110C_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2110C.AMT, Dom.Segments.AMT)
			Private Property AMT_IFace_Loop2110C_Obj As Transaction270_B1.Segments.Loop2110C.AMT Implements Transaction270_B1.Loops.Loop2110C.AMT
				Get
					If AMTSubset_Loop2110C_Obj Is Nothing Then
						AMTSubset_Loop2110C_Obj = New SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2110C.AMT, Dom.Segments.AMT)(Children(1), 1, 4, 6589)
					End If
				...
				End Set
			End Property
			Private AMT_1Subset_Loop2110C_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2110C.AMT_1, Dom.Segments.AMT)
			Private Property AMT_IFace_1_Loop2110C_Obj As Transaction270_B1.Segments.Loop2110C.AMT_1 Implements Transaction270_B1.Loops.Loop2110C.AMT_1
				Get
					If AMT_1Subset_Loop2110C_Obj Is Nothing Then
						AMT_1Subset_Loop2110C_Obj = New SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2110C.AMT_1, Dom.Segments.AMT)(Children(1), 1, 4, 239869)
					End If
			...
			Friend Property VEH_Obj As Dom.Segments.VEH_Obj
				Get
					Return CType(Children(2), Dom.Segments.VEH_Obj)
				End Get
			...
			Private Property VEH_Std As Dom.Segments.VEH Implements Loops.Loop2110.VEH
				Get
					Return CType(Children(2), Dom.Segments.VEH_Obj)
				End Get
			...
			Friend Property PDR_Obj As Dom.Segments.PDR_Obj
				Get
					Return CType(Children(3), Dom.Segments.PDR_Obj)
				End Get
			...
			Private Property PDR_Std As Dom.Segments.PDR Implements Loops.Loop2110.PDR
				Get
					Return CType(Children(3), Dom.Segments.PDR_Obj)
				End Get
			...
			Friend Property PDP_Obj As Dom.Segments.PDP_Obj
				Get
					Return CType(Children(4), Dom.Segments.PDP_Obj)
				End Get
			...
			Private Property PDP_Std As Dom.Segments.PDP Implements Loops.Loop2110.PDP
				Get
					Return CType(Children(4), Dom.Segments.PDP_Obj)
				End Get
			...
			Friend ReadOnly Property III_Obj As SegmentContainer(Of Dom.Segments.III) Implements Loops.Loop2110.III
				Get
					Return CType(Children(5), SegmentContainer(Of Dom.Segments.III))
				End Get
			End Property

			Private IIISubset_Loop2110C_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2110C.III, Dom.Segments.III)
			Private Property III_IFace_Loop2110C_Obj As Transaction270_B1.Segments.Loop2110C.III Implements Transaction270_B1.Loops.Loop2110C.III
				Get
					If IIISubset_Loop2110C_Obj Is Nothing Then
						IIISubset_Loop2110C_Obj = New SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2110C.III, Dom.Segments.III)(Children(5), 1, 4, 11773)
					End If
				...
				End Set
			End Property
			Private IIISubset_1_Loop2110D_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2110D.III, Dom.Segments.III)
			Private Property III_IFace_1_Loop2110D_Obj As Transaction270_B1.Segments.Loop2110D.III Implements Transaction270_B1.Loops.Loop2110D.III
				Get
					If IIISubset_1_Loop2110D_Obj Is Nothing Then
						IIISubset_1_Loop2110D_Obj = New SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2110D.III, Dom.Segments.III)(Children(5), 1, 5, 11773)
					End If
			...
			Friend Property REF_Obj As Dom.Segments.REF_Obj
				Get
					Return CType(Children(6), Dom.Segments.REF_Obj)
				End Get
			...
			Private Property REF_Std As Dom.Segments.REF Implements Loops.Loop2110.REF
				Get
					Return CType(Children(6), Dom.Segments.REF_Obj)
				End Get
			...
			Private Property REF_IFace_1_Loop2110D_Obj As Transaction270_B1.Segments.Loop2110D.REF Implements Transaction270_B1.Loops.Loop2110D.REF
				...
				End Set
			End Property
			Friend ReadOnly Property DTP_Obj As SegmentContainer(Of Dom.Segments.DTP) Implements Loops.Loop2110.DTP
				Get
					Return CType(Children(7), SegmentContainer(Of Dom.Segments.DTP))
				End Get
			End Property

			Private DTPSubset_Loop2110C_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2110C.DTP, Dom.Segments.DTP)
			Private Property DTP_IFace_Loop2110C_Obj As Transaction270_B1.Segments.Loop2110C.DTP Implements Transaction270_B1.Loops.Loop2110C.DTP
				Get
					If DTPSubset_Loop2110C_Obj Is Nothing Then
						DTPSubset_Loop2110C_Obj = New SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2110C.DTP, Dom.Segments.DTP)(Children(7), 1, 4, 181)
					End If
				...
				End Set
			End Property
			Private DTPSubset_1_Loop2110D_Obj As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2110D.DTP, Dom.Segments.DTP)
			Private Property DTP_IFace_1_Loop2110D_Obj As Transaction270_B1.Segments.Loop2110D.DTP Implements Transaction270_B1.Loops.Loop2110D.DTP
				Get
					If DTPSubset_1_Loop2110D_Obj Is Nothing Then
						DTPSubset_1_Loop2110D_Obj = New SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2110D.DTP, Dom.Segments.DTP)(Children(7), 1, 5, 181)
					End If
		...
		Namespace Loops
			...
			Public Interface Loop2000
				...
				ReadOnly Property Loop2100 As LoopContainer(Of Loops.Loop2100)
			End Interface
			'''<summary></summary>
			'''<remarks></remarks>
			Public Interface Loop2100
				...
				ReadOnly Property Loop2110 As LoopContainer(Of Loops.Loop2110)
			End Interface
			'''<summary></summary>
			'''<remarks></remarks>
			Public Interface Loop2110
				Inherits ILoop
				'''<summary>Eligibility or Benefit Inquiry</summary>
				Property EQ As Dom.Segments.EQ
				...
				ReadOnly Property III As SegmentContainer(Of Dom.Segments.III)
				'''<summary>Reference Information</summary>
		...
		Namespace Transaction270_B1
			Namespace Segments
				...
				Namespace Loop2100C
					...
					Public Interface HI
						...
						'''<summary></summary>
						Property HI01 As Transaction270_B1.Composites.Loop2100C.HI.HI_01.C022
						'''<summary></summary>
						Property HI02 As Transaction270_B1.Composites.Loop2100C.HI.HI_02.C022
						'''<summary></summary>
						Property HI03 As Transaction270_B1.Composites.Loop2100C.HI.HI_03.C022
						'''<summary></summary>
						Property HI04 As Transaction270_B1.Composites.Loop2100C.HI.HI_04.C022
						'''<summary></summary>
						Property HI05 As Transaction270_B1.Composites.Loop2100C.HI.HI_05.C022
						'''<summary></summary>
						Property HI06 As Transaction270_B1.Composites.Loop2100C.HI.HI_06.C022
						'''<summary></summary>
						Property HI07 As Transaction270_B1.Composites.Loop2100C.HI.HI_07.C022
						'''<summary></summary>
						Property HI08 As Transaction270_B1.Composites.Loop2100C.HI.HI_08.C022
					End Interface
				...
				Namespace Loop2110C
					...
					Public Interface EQ
						...
						Property EQ02 As Transaction270_B1.Composites.Loop2110C.EQ.EQ_02.C003
						'''<summary>Coverage Level Code</summary>
						Property EQ03 As String
						'''<summary></summary>
						Property EQ05 As Dom.DataElements.Composite.C004
					End Interface
				...
				Namespace Loop2100D
					...
					Public Interface HI
						...
						'''<summary></summary>
						Property HI01 As Transaction270_B1.Composites.Loop2100D.HI.HI_01.C022
						'''<summary></summary>
						Property HI02 As Transaction270_B1.Composites.Loop2100D.HI.HI_02.C022
						'''<summary></summary>
						Property HI03 As Transaction270_B1.Composites.Loop2100D.HI.HI_03.C022
						'''<summary></summary>
						Property HI04 As Transaction270_B1.Composites.Loop2100D.HI.HI_04.C022
						'''<summary></summary>
						Property HI05 As Transaction270_B1.Composites.Loop2100D.HI.HI_05.C022
						'''<summary></summary>
						Property HI06 As Transaction270_B1.Composites.Loop2100D.HI.HI_06.C022
						'''<summary></summary>
						Property HI07 As Transaction270_B1.Composites.Loop2100D.HI.HI_07.C022
						'''<summary></summary>
						Property HI08 As Transaction270_B1.Composites.Loop2100D.HI.HI_08.C022
					End Interface
				...
				Namespace Loop2110D
					...
					Public Interface EQ
						...
						Property EQ01 As String
						'''<summary></summary>
						Property EQ02 As Transaction270_B1.Composites.Loop2110D.EQ.EQ_02.C003
						'''<summary></summary>
						Property EQ05 As Dom.DataElements.Composite.C004
					End Interface
			...
			Namespace Loops
				...
				Public Interface Loop2000A
					...
					'''<summary>Information Source Level</summary>
					Property HL As Transaction270_B1.Segments.Loop2000A.HL

					'''<summary>Information Source Name</summary>
					Property Loop2100A As Transaction270_B1.Loops.Loop2100A
				End Interface
				'''<summary>Information Source Name</summary>
				Public Interface Loop2100A
					...
					'''<summary>Information Source Name</summary>
					Property NM1 As Transaction270_B1.Segments.Loop2100A.NM1
				End Interface
				'''<summary>Information Receiver Level</summary>
				Public Interface Loop2000B
					...
					'''<summary>Information Receiver Level</summary>
					Property HL As Transaction270_B1.Segments.Loop2000B.HL

					'''<summary>Information Receiver Name</summary>
					Property Loop2100B As Transaction270_B1.Loops.Loop2100B
				End Interface
				'''<summary>Information Receiver Name</summary>
				Public Interface Loop2100B
					...
					'''<summary>Information Receiver Name</summary>
					Property NM1 As Transaction270_B1.Segments.Loop2100B.NM1

					'''<summary>Information Receiver Additional Identification</summary>
					ReadOnly Property REF As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100B.REF, Dom.Segments.REF)

					'''<summary>Information Receiver Address</summary>
					Property N3 As Transaction270_B1.Segments.Loop2100B.N3

					'''<summary>Information Receiver City, State, ZIP Code</summary>
					Property N4 As Transaction270_B1.Segments.Loop2100B.N4

					'''<summary>Information Receiver Provider Information</summary>
					Property PRV As Transaction270_B1.Segments.Loop2100B.PRV
				End Interface
				'''<summary>Subscriber Level</summary>
				Public Interface Loop2000C
					...
					'''<summary>Subscriber Level</summary>
					Property HL As Transaction270_B1.Segments.Loop2000C.HL

					'''<summary>Subscriber Trace Number</summary>
					ReadOnly Property TRN As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2000C.TRN, Dom.Segments.TRN)

					'''<summary>Subscriber Name</summary>
					Property Loop2100C As Transaction270_B1.Loops.Loop2100C
				End Interface
				'''<summary>Subscriber Name</summary>
				Public Interface Loop2100C
					...
					'''<summary>Subscriber Name</summary>
					Property NM1 As Transaction270_B1.Segments.Loop2100C.NM1

					'''<summary>Subscriber Additional Identification</summary>
					ReadOnly Property REF As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100C.REF, Dom.Segments.REF)

					'''<summary>Subscriber Address</summary>
					Property N3 As Transaction270_B1.Segments.Loop2100C.N3

					'''<summary>Subscriber City, State, ZIP Code</summary>
					Property N4 As Transaction270_B1.Segments.Loop2100C.N4

					'''<summary>Provider Information</summary>
					Property PRV As Transaction270_B1.Segments.Loop2100C.PRV

					'''<summary>Subscriber Demographic Information</summary>
					Property DMG As Transaction270_B1.Segments.Loop2100C.DMG

					'''<summary>Multiple Birth Sequence Number</summary>
					Property INS As Transaction270_B1.Segments.Loop2100C.INS

					'''<summary>Subscriber Health Care Diagnosis Code</summary>
					Property HI As Transaction270_B1.Segments.Loop2100C.HI

					'''<summary>Subscriber Date</summary>
					ReadOnly Property DTP As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100C.DTP, Dom.Segments.DTP)

					'''<summary>Subscriber Eligibility or Benefit Inquiry</summary>
					ReadOnly Property Loop2110C As LoopSubsetContainer(Of Transaction270_B1.Loops.Loop2110C, Transaction270.Loops.Loop2110)
				End Interface
				'''<summary>Subscriber Eligibility or Benefit Inquiry</summary>
				Public Interface Loop2110C
					...
					'''<summary>Subscriber Eligibility or Benefit Inquiry</summary>
					Property EQ As Transaction270_B1.Segments.Loop2110C.EQ

					'''<summary>Subscriber Spend Down Amount</summary>
					Property AMT As Transaction270_B1.Segments.Loop2110C.AMT

					'''<summary>Subscriber Spend Down Total Billed Amount</summary>
					Property AMT_1 As Transaction270_B1.Segments.Loop2110C.AMT_1

					'''<summary>Subscriber Eligibility or Benefit Additional Inquiry Information</summary>
					Property III As Transaction270_B1.Segments.Loop2110C.III

					'''<summary>Subscriber Additional Information</summary>
					Property REF As Transaction270_B1.Segments.Loop2110C.REF

					'''<summary>Subscriber Eligibility/Benefit Date</summary>
					Property DTP As Transaction270_B1.Segments.Loop2110C.DTP
				End Interface
				'''<summary>Dependent Level</summary>
				Public Interface Loop2000D
					...
					'''<summary>Dependent Level</summary>
					Property HL As Transaction270_B1.Segments.Loop2000D.HL

					'''<summary>Dependent Trace Number</summary>
					ReadOnly Property TRN As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2000D.TRN, Dom.Segments.TRN)

					'''<summary>Dependent Name</summary>
					Property Loop2100D As Transaction270_B1.Loops.Loop2100D
				End Interface
				'''<summary>Dependent Name</summary>
				Public Interface Loop2100D
					...
					'''<summary>Dependent Name</summary>
					Property NM1 As Transaction270_B1.Segments.Loop2100D.NM1

					'''<summary>Dependent Additional Identification</summary>
					ReadOnly Property REF As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100D.REF, Dom.Segments.REF)

					'''<summary>Dependent Address</summary>
					Property N3 As Transaction270_B1.Segments.Loop2100D.N3

					'''<summary>Dependent City, State, ZIP Code</summary>
					Property N4 As Transaction270_B1.Segments.Loop2100D.N4

					'''<summary>Provider Information</summary>
					Property PRV As Transaction270_B1.Segments.Loop2100D.PRV

					'''<summary>Dependent Demographic Information</summary>
					Property DMG As Transaction270_B1.Segments.Loop2100D.DMG

					'''<summary>Dependent Relationship</summary>
					Property INS As Transaction270_B1.Segments.Loop2100D.INS

					'''<summary>Dependent Health Care Diagnosis Code</summary>
					Property HI As Transaction270_B1.Segments.Loop2100D.HI

					'''<summary>Dependent Date</summary>
					ReadOnly Property DTP As SegmentSubsetContainer(Of Transaction270_B1.Segments.Loop2100D.DTP, Dom.Segments.DTP)

					'''<summary>Dependent Eligibility or Benefit Inquiry</summary>
					ReadOnly Property Loop2110D As LoopSubsetContainer(Of Transaction270_B1.Loops.Loop2110D, Transaction270.Loops.Loop2110)
				End Interface
				'''<summary>Dependent Eligibility or Benefit Inquiry</summary>
				Public Interface Loop2110D
					...
					'''<summary>Dependent Eligibility or Benefit Inquiry</summary>
					Property EQ As Transaction270_B1.Segments.Loop2110D.EQ

					'''<summary>Dependent Eligibility or Benefit Additional Inquiry Information</summary>
					Property III As Transaction270_B1.Segments.Loop2110D.III

					'''<summary>Dependent Additional Information</summary>
					Property REF As Transaction270_B1.Segments.Loop2110D.REF

					'''<summary>Dependent Eligibility/Benefit Date</summary>
					Property DTP As Transaction270_B1.Segments.Loop2110D.DTP
				End Interface
			...
			Public Interface TransactionSet
				...
				'''<summary>Transaction Set Header</summary>
				Property ST As Transaction270_B1.Segments.ST

				'''<summary>Beginning of Hierarchical Transaction</summary>
				Property BHT As Transaction270_B1.Segments.BHT

				'''<summary>Information Source Level</summary>
				ReadOnly Property Loop2000A As LoopSubsetContainer(Of Transaction270_B1.Loops.Loop2000A, Transaction270.Loops.Loop2000)

				'''<summary>Information Receiver Level</summary>
				ReadOnly Property Loop2000B As LoopSubsetContainer(Of Transaction270_B1.Loops.Loop2000B, Transaction270.Loops.Loop2000)

				'''<summary>Subscriber Level</summary>
				ReadOnly Property Loop2000C As LoopSubsetContainer(Of Transaction270_B1.Loops.Loop2000C, Transaction270.Loops.Loop2000)

				'''<summary>Dependent Level</summary>
				ReadOnly Property Loop2000D As LoopSubsetContainer(Of Transaction270_B1.Loops.Loop2000D, Transaction270.Loops.Loop2000)

				'''<summary>Transaction Set Trailer</summary>
				Property SE As Transaction270_B1.Segments.SE
			End Interface
