Namespace Transactions
	Namespace Transaction270
		...
		Partial Friend Class Standard_Obj
			...
			Implements Standard, Edi.Dom.Transactions.Transaction270.Transaction270_B1.TransactionSet
			...
			Friend Sub New(controlNumber As String, versionCode As String)
				...
				Children.AddRange({New Edi.Dom.Segments.ST_Obj,
																...
																New LoopContainer(Of Edi.Dom.Transactions.Transaction270.Loops.Loop2000)(0, "2", "0100"),
			...
			Private Async Function PopulateChildLoop(ByVal args As ReaderArgs) As Task
				...
				If String.Compare(args.DataSegment.SegmentID, "HL", StringComparison.OrdinalIgnoreCase) = 0 Then
					Dim NewLoop As LoopBase = New Edi.Dom.Transactions.Transaction270.Loop2000_Obj
			...
			Private Property ST_Std As Edi.Dom.Segments.ST Implements Edi.Dom.Transactions.Transaction270.Standard.ST
				Get
					Return CType(Children(0), Edi.Dom.Segments.ST_Obj)
				End Get
			...
			Private Property ST_IFace_Transaction270_B1 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.ST Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.TransactionSet.ST
				Get
					Return CType(Children(0), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.ST)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.ST)
					Children(0) = value
				End Set
			End Property
			...
			Private Property BHT_Std As Edi.Dom.Segments.BHT Implements Edi.Dom.Transactions.Transaction270.Standard.BHT
				Get
					Return CType(Children(1), Edi.Dom.Segments.BHT_Obj)
				End Get
			...
			Private Property BHT_IFace_Transaction270_B1 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.BHT Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.TransactionSet.BHT
				Get
					Return CType(Children(1), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.BHT)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.BHT)
					Children(1) = value
				End Set
			End Property
			Friend ReadOnly Property Loop2000_Obj As LoopContainer(Of Edi.Dom.Transactions.Transaction270.Loops.Loop2000) Implements Edi.Dom.Transactions.Transaction270.Standard.Loop2000
				Get
					Return CType(Children(2), LoopContainer(Of Edi.Dom.Transactions.Transaction270.Loops.Loop2000))
				End Get
			End Property

			Private Loop2000ASubset_Transaction270_B1 As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000A, Edi.Dom.Transactions.Transaction270.Loops.Loop2000)
			Private ReadOnly Property Loop2000A_Obj_Transaction270_B1 As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000A, Edi.Dom.Transactions.Transaction270.Loops.Loop2000) Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.TransactionSet.Loop2000A
				Get
					If Loop2000ASubset_Transaction270_B1 Is Nothing Then
						Loop2000ASubset_Transaction270_B1 = New LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000A, Edi.Dom.Transactions.Transaction270.Loops.Loop2000)(Children(2), 0, "2", "0100")
					End If

					Return Loop2000ASubset_Transaction270_B1
				End Get
			End Property
			Private Loop2000BSubset_Transaction270_B1 As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000B, Edi.Dom.Transactions.Transaction270.Loops.Loop2000)
			Private ReadOnly Property Loop2000B_Obj_Transaction270_B1 As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000B, Edi.Dom.Transactions.Transaction270.Loops.Loop2000) Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.TransactionSet.Loop2000B
				Get
					If Loop2000BSubset_Transaction270_B1 Is Nothing Then
						Loop2000BSubset_Transaction270_B1 = New LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000B, Edi.Dom.Transactions.Transaction270.Loops.Loop2000)(Children(2), 0, "3", "0100")
					End If

					Return Loop2000BSubset_Transaction270_B1
				End Get
			End Property
			Private Loop2000CSubset_Transaction270_B1 As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000C, Edi.Dom.Transactions.Transaction270.Loops.Loop2000)
			Private ReadOnly Property Loop2000C_Obj_Transaction270_B1 As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000C, Edi.Dom.Transactions.Transaction270.Loops.Loop2000) Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.TransactionSet.Loop2000C
				Get
					If Loop2000CSubset_Transaction270_B1 Is Nothing Then
						Loop2000CSubset_Transaction270_B1 = New LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000C, Edi.Dom.Transactions.Transaction270.Loops.Loop2000)(Children(2), 0, "4", "0100")
					End If

					Return Loop2000CSubset_Transaction270_B1
				End Get
			End Property
			Private Loop2000DSubset_Transaction270_B1 As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000D, Edi.Dom.Transactions.Transaction270.Loops.Loop2000)
			Private ReadOnly Property Loop2000D_Obj_Transaction270_B1 As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000D, Edi.Dom.Transactions.Transaction270.Loops.Loop2000) Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.TransactionSet.Loop2000D
				Get
					If Loop2000DSubset_Transaction270_B1 Is Nothing Then
						Loop2000DSubset_Transaction270_B1 = New LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000D, Edi.Dom.Transactions.Transaction270.Loops.Loop2000)(Children(2), 0, "5", "0100")
					End If
			...
			Private Property SE_Std As Edi.Dom.Segments.SE Implements Edi.Dom.Transactions.Transaction270.Standard.SE
				Get
					Return CType(Children(3), Edi.Dom.Segments.SE_Obj)
				End Get
			...
			Private Property SE_IFace_Transaction270_B1 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.SE Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.TransactionSet.SE
				Get
					Return CType(Children(3), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.SE)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.SE)
					Children(3) = value
				End Set
			End Property
		End Class
		...
		Partial Friend Class Loop2000_Obj
			Inherits LoopBase
			Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2000,
														Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000A,
														Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000B,
														Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000C,
														Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000D
			Friend Sub New()
				MyBase.New

				Children.AddRange({CType(Nothing, Edi.Dom.Segments.HL_Obj),
																	New SegmentContainer(Of Edi.Dom.Segments.TRN)(9, "2", "0200"),
																	New LoopContainer(Of Edi.Dom.Transactions.Transaction270.Loops.Loop2100)(0, "2", "0300")})
			...
			Private Async Function PopulateChildLoop(ByVal args As ReaderArgs) As Task
				...
				If String.Compare(args.DataSegment.SegmentID, "NM1", StringComparison.OrdinalIgnoreCase) = 0 Then
					Dim NewLoop As LoopBase = New Edi.Dom.Transactions.Transaction270.Loop2100_Obj
			...
			Private Property HL_Std As Edi.Dom.Segments.HL Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2000.HL
				Get
					Return CType(Children(0), Edi.Dom.Segments.HL_Obj)
				End Get
			...
			Private Property HL_IFace_Loop2000A_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000A.HL Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000A.HL
				Get
					Return CType(Children(0), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000A.HL)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000A.HL)
					Children(0) = value
				End Set
			End Property
			Private Property HL_IFace_1_Loop2000B_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000B.HL Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000B.HL
				Get
					Return CType(Children(0), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000B.HL)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000B.HL)
					Children(0) = value
				End Set
			End Property
			Private Property HL_IFace_2_Loop2000C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000C.HL Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000C.HL
				Get
					Return CType(Children(0), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000C.HL)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000C.HL)
					Children(0) = value
				End Set
			End Property
			Private Property HL_IFace_3_Loop2000D_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000D.HL Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000D.HL
				Get
					Return CType(Children(0), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000D.HL)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000D.HL)
					Children(0) = value
				End Set
			End Property
			Friend ReadOnly Property TRN_Obj As SegmentContainer(Of Edi.Dom.Segments.TRN) Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2000.TRN
				Get
					Return CType(Children(1), SegmentContainer(Of Edi.Dom.Segments.TRN))
				End Get
			End Property

			Private TRNSubset_Loop2000C_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000C.TRN, Edi.Dom.Segments.TRN)
			Private ReadOnly Property TRN_Loop2000C_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000C.TRN, Edi.Dom.Segments.TRN) Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000C.TRN
				Get
					If TRNSubset_Loop2000C_Obj Is Nothing Then
						TRNSubset_Loop2000C_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000C.TRN, Edi.Dom.Segments.TRN)(Children(1), 2, "4", "0200")
					End If

					Return TRNSubset_Loop2000C_Obj
				End Get
			End Property
			Private TRNSubset_1_Loop2000D_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000D.TRN, Edi.Dom.Segments.TRN)
			Private ReadOnly Property TRN_Loop2000D_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000D.TRN, Edi.Dom.Segments.TRN) Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000D.TRN
				Get
					If TRNSubset_1_Loop2000D_Obj Is Nothing Then
						TRNSubset_1_Loop2000D_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000D.TRN, Edi.Dom.Segments.TRN)(Children(1), 2, "5", "0200")
					End If

					Return TRNSubset_1_Loop2000D_Obj
				End Get
			End Property
			Friend ReadOnly Property Loop2100_Obj As LoopContainer(Of Edi.Dom.Transactions.Transaction270.Loops.Loop2100) Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2000.Loop2100
				Get
					Return CType(Children(2), LoopContainer(Of Edi.Dom.Transactions.Transaction270.Loops.Loop2100))
				End Get
			End Property

			Private Loop2100ASubset_Loop2000A_Obj As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100A, Edi.Dom.Transactions.Transaction270.Loops.Loop2100)
			Private Property Loop2100A_IFace_Loop2000A_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100A Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000A.Loop2100A
				Get
					If Loop2100ASubset_Loop2000A_Obj Is Nothing Then
						Loop2100ASubset_Loop2000A_Obj = New LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100A, Edi.Dom.Transactions.Transaction270.Loops.Loop2100)(Children(2), 1, "2", "0300")
					End If
					...
					End If
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100A)
					If Loop2100ASubset_Loop2000A_Obj Is Nothing Then
						Loop2100ASubset_Loop2000A_Obj = New LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100A, Edi.Dom.Transactions.Transaction270.Loops.Loop2100)(Children(2), 1, "2", "0300")
					End If
				...
				End Set
			End Property
			Private Loop2100BSubset_Loop2000B_Obj As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100B, Edi.Dom.Transactions.Transaction270.Loops.Loop2100)
			Private Property Loop2100B_IFace_Loop2000B_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100B Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000B.Loop2100B
				Get
					If Loop2100BSubset_Loop2000B_Obj Is Nothing Then
						Loop2100BSubset_Loop2000B_Obj = New LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100B, Edi.Dom.Transactions.Transaction270.Loops.Loop2100)(Children(2), 1, "3", "0300")
					End If
					...
					End If
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100B)
					If Loop2100BSubset_Loop2000B_Obj Is Nothing Then
						Loop2100BSubset_Loop2000B_Obj = New LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100B, Edi.Dom.Transactions.Transaction270.Loops.Loop2100)(Children(2), 1, "3", "0300")
					End If
				...
				End Set
			End Property
			Private Loop2100CSubset_Loop2000C_Obj As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C, Edi.Dom.Transactions.Transaction270.Loops.Loop2100)
			Private Property Loop2100C_IFace_Loop2000C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000C.Loop2100C
				Get
					If Loop2100CSubset_Loop2000C_Obj Is Nothing Then
						Loop2100CSubset_Loop2000C_Obj = New LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C, Edi.Dom.Transactions.Transaction270.Loops.Loop2100)(Children(2), 1, "4", "0300")
					End If
					...
					End If
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C)
					If Loop2100CSubset_Loop2000C_Obj Is Nothing Then
						Loop2100CSubset_Loop2000C_Obj = New LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C, Edi.Dom.Transactions.Transaction270.Loops.Loop2100)(Children(2), 1, "4", "0300")
					End If
				...
				End Set
			End Property
			Private Loop2100DSubset_Loop2000D_Obj As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D, Edi.Dom.Transactions.Transaction270.Loops.Loop2100)
			Private Property Loop2100D_IFace_Loop2000D_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000D.Loop2100D
				Get
					If Loop2100DSubset_Loop2000D_Obj Is Nothing Then
						Loop2100DSubset_Loop2000D_Obj = New LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D, Edi.Dom.Transactions.Transaction270.Loops.Loop2100)(Children(2), 1, "5", "0300")
					End If
					...
					End If
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D)
					If Loop2100DSubset_Loop2000D_Obj Is Nothing Then
						Loop2100DSubset_Loop2000D_Obj = New LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D, Edi.Dom.Transactions.Transaction270.Loops.Loop2100)(Children(2), 1, "5", "0300")
					End If
		...
		Partial Friend Class Loop2100_Obj
			Inherits LoopBase
			Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2100,
														Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100A,
														Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100B,
														Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C,
														Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D
			Friend Sub New()
				MyBase.New
				...
				Children.AddRange({CType(Nothing, Edi.Dom.Segments.NM1_Obj),
																	...
																	New SegmentContainer(Of Edi.Dom.Segments.MPI)(9, "2", "1250"),
																	New LoopContainer(Of Edi.Dom.Transactions.Transaction270.Loops.Loop2110)(99, "2", "1300")})
			...
			Private Async Function PopulateChildLoop(ByVal args As ReaderArgs) As Task
				...
				If String.Compare(args.DataSegment.SegmentID, "EQ", StringComparison.OrdinalIgnoreCase) = 0 Then
					Dim NewLoop As LoopBase = New Edi.Dom.Transactions.Transaction270.Loop2110_Obj
					Dim LoopKey As String = args.DataSegment.ToStringValue(0)
			...
			Private Property NM1_Std As Edi.Dom.Segments.NM1 Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2100.NM1
				Get
					Return CType(Children(0), Edi.Dom.Segments.NM1_Obj)
				End Get
			...
			Private Property NM1_IFace_Loop2100A_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100A.NM1 Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100A.NM1
				Get
					Return CType(Children(0), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100A.NM1)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100A.NM1)
					Children(0) = value
				End Set
			End Property
			Private Property NM1_IFace_1_Loop2100B_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.NM1 Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100B.NM1
				Get
					Return CType(Children(0), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.NM1)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.NM1)
					Children(0) = value
				End Set
			End Property
			Private Property NM1_IFace_2_Loop2100C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.NM1 Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C.NM1
				Get
					Return CType(Children(0), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.NM1)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.NM1)
					Children(0) = value
				End Set
			End Property
			Private Property NM1_IFace_3_Loop2100D_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.NM1 Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D.NM1
				Get
					Return CType(Children(0), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.NM1)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.NM1)
					Children(0) = value
				End Set
			End Property
			Friend ReadOnly Property REF_Obj As SegmentContainer(Of Edi.Dom.Segments.REF) Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2100.REF
				Get
					Return CType(Children(1), SegmentContainer(Of Edi.Dom.Segments.REF))
				End Get
			End Property

			Private REFSubset_Loop2100B_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.REF, Edi.Dom.Segments.REF)
			Private ReadOnly Property REF_Loop2100B_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.REF, Edi.Dom.Segments.REF) Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100B.REF
				Get
					If REFSubset_Loop2100B_Obj Is Nothing Then
						REFSubset_Loop2100B_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.REF, Edi.Dom.Segments.REF)(Children(1), 9, "3", "0400")
					End If

					Return REFSubset_Loop2100B_Obj
				End Get
			End Property
			Private REFSubset_1_Loop2100C_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.REF, Edi.Dom.Segments.REF)
			Private ReadOnly Property REF_Loop2100C_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.REF, Edi.Dom.Segments.REF) Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C.REF
				Get
					If REFSubset_1_Loop2100C_Obj Is Nothing Then
						REFSubset_1_Loop2100C_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.REF, Edi.Dom.Segments.REF)(Children(1), 9, "4", "0400")
					End If

					Return REFSubset_1_Loop2100C_Obj
				End Get
			End Property
			Private REFSubset_2_Loop2100D_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.REF, Edi.Dom.Segments.REF)
			Private ReadOnly Property REF_Loop2100D_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.REF, Edi.Dom.Segments.REF) Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D.REF
				Get
					If REFSubset_2_Loop2100D_Obj Is Nothing Then
						REFSubset_2_Loop2100D_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.REF, Edi.Dom.Segments.REF)(Children(1), 9, "5", "0400")
					End If
			...
			Private Property N2_Std As Edi.Dom.Segments.N2 Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2100.N2
				Get
					Return CType(Children(2), Edi.Dom.Segments.N2_Obj)
				End Get
			...
			Private Property N3_Std As Edi.Dom.Segments.N3 Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2100.N3
				Get
					Return CType(Children(3), Edi.Dom.Segments.N3_Obj)
				End Get
			...
			Private Property N3_IFace_Loop2100B_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.N3 Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100B.N3
				Get
					Return CType(Children(3), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.N3)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.N3)
					Children(3) = value
				End Set
			End Property
			Private Property N3_IFace_1_Loop2100C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.N3 Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C.N3
				Get
					Return CType(Children(3), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.N3)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.N3)
					Children(3) = value
				End Set
			End Property
			Private Property N3_IFace_2_Loop2100D_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.N3 Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D.N3
				Get
					Return CType(Children(3), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.N3)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.N3)
					Children(3) = value
				End Set
			End Property
			...
			Private Property N4_Std As Edi.Dom.Segments.N4 Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2100.N4
				Get
					Return CType(Children(4), Edi.Dom.Segments.N4_Obj)
				End Get
			...
			Private Property N4_IFace_Loop2100B_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.N4 Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100B.N4
				Get
					Return CType(Children(4), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.N4)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.N4)
					Children(4) = value
				End Set
			End Property
			Private Property N4_IFace_1_Loop2100C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.N4 Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C.N4
				Get
					Return CType(Children(4), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.N4)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.N4)
					Children(4) = value
				End Set
			End Property
			Private Property N4_IFace_2_Loop2100D_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.N4 Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D.N4
				Get
					Return CType(Children(4), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.N4)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.N4)
					Children(4) = value
				End Set
			End Property
			Friend ReadOnly Property PER_Obj As SegmentContainer(Of Edi.Dom.Segments.PER) Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2100.PER
				Get
			...
			Friend Property PRV_Obj As Edi.Dom.Segments.PRV_Obj
				Get
					Return CType(Children(6), Edi.Dom.Segments.PRV_Obj)
				End Get
			...
			Private Property PRV_Std As Edi.Dom.Segments.PRV Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2100.PRV
				Get
					Return CType(Children(6), Edi.Dom.Segments.PRV_Obj)
				End Get
			...
			Private Property PRV_IFace_Loop2100B_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.PRV Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100B.PRV
				Get
					Return CType(Children(6), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.PRV)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.PRV)
					Children(6) = value
				End Set
			End Property
			Private Property PRV_IFace_1_Loop2100C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.PRV Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C.PRV
				Get
					Return CType(Children(6), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.PRV)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.PRV)
					Children(6) = value
				End Set
			End Property
			Private Property PRV_IFace_2_Loop2100D_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.PRV Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D.PRV
				Get
					Return CType(Children(6), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.PRV)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.PRV)
					Children(6) = value
				End Set
			End Property
			Friend Property DMG_Obj As Edi.Dom.Segments.DMG_Obj
				Get
					Return CType(Children(7), Edi.Dom.Segments.DMG_Obj)
				End Get
			...
			Private Property DMG_Std As Edi.Dom.Segments.DMG Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2100.DMG
				Get
					Return CType(Children(7), Edi.Dom.Segments.DMG_Obj)
				End Get
			...
			Private Property DMG_IFace_Loop2100C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.DMG Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C.DMG
				Get
					Return CType(Children(7), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.DMG)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.DMG)
					Children(7) = value
				End Set
			End Property
			Private Property DMG_IFace_1_Loop2100D_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.DMG Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D.DMG
				Get
					Return CType(Children(7), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.DMG)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.DMG)
					Children(7) = value
				End Set
			End Property
			Friend Property INS_Obj As Edi.Dom.Segments.INS_Obj
				Get
					Return CType(Children(8), Edi.Dom.Segments.INS_Obj)
				End Get
			...
			Private Property INS_Std As Edi.Dom.Segments.INS Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2100.INS
				Get
					Return CType(Children(8), Edi.Dom.Segments.INS_Obj)
				End Get
			...
			Private Property INS_IFace_Loop2100C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.INS Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C.INS
				Get
					Return CType(Children(8), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.INS)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.INS)
					Children(8) = value
				End Set
			End Property
			Private Property INS_IFace_1_Loop2100D_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.INS Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D.INS
				Get
					Return CType(Children(8), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.INS)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.INS)
					Children(8) = value
				End Set
			End Property
			Friend Property HI_Obj As Edi.Dom.Segments.HI_Obj
				Get
					Return CType(Children(9), Edi.Dom.Segments.HI_Obj)
				End Get
			...
			Private Property HI_Std As Edi.Dom.Segments.HI Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2100.HI
				Get
					Return CType(Children(9), Edi.Dom.Segments.HI_Obj)
				End Get
			...
			Private Property HI_IFace_Loop2100C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.HI Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C.HI
				Get
					Return CType(Children(9), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.HI)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.HI)
					Children(9) = value
				End Set
			End Property
			Private Property HI_IFace_1_Loop2100D_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.HI Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D.HI
				Get
					Return CType(Children(9), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.HI)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.HI)
					Children(9) = value
				End Set
			End Property
			Friend ReadOnly Property DTP_Obj As SegmentContainer(Of Edi.Dom.Segments.DTP) Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2100.DTP
				Get
					Return CType(Children(10), SegmentContainer(Of Edi.Dom.Segments.DTP))
				End Get
			End Property

			Private DTPSubset_Loop2100C_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.DTP, Edi.Dom.Segments.DTP)
			Private ReadOnly Property DTP_Loop2100C_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.DTP, Edi.Dom.Segments.DTP) Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C.DTP
				Get
					If DTPSubset_Loop2100C_Obj Is Nothing Then
						DTPSubset_Loop2100C_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.DTP, Edi.Dom.Segments.DTP)(Children(10), 2, "4", "1200")
					End If

					Return DTPSubset_Loop2100C_Obj
				End Get
			End Property
			Private DTPSubset_1_Loop2100D_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.DTP, Edi.Dom.Segments.DTP)
			Private ReadOnly Property DTP_Loop2100D_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.DTP, Edi.Dom.Segments.DTP) Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D.DTP
				Get
					If DTPSubset_1_Loop2100D_Obj Is Nothing Then
						DTPSubset_1_Loop2100D_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.DTP, Edi.Dom.Segments.DTP)(Children(10), 2, "5", "1200")
					End If

					Return DTPSubset_1_Loop2100D_Obj
				End Get
			End Property
			Friend ReadOnly Property MPI_Obj As SegmentContainer(Of Edi.Dom.Segments.MPI) Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2100.MPI
				Get
					Return CType(Children(11), SegmentContainer(Of Edi.Dom.Segments.MPI))
				End Get
			End Property

			Friend ReadOnly Property Loop2110_Obj As LoopContainer(Of Edi.Dom.Transactions.Transaction270.Loops.Loop2110) Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2100.Loop2110
				Get
					Return CType(Children(12), LoopContainer(Of Edi.Dom.Transactions.Transaction270.Loops.Loop2110))
				End Get
			End Property

			Private Loop2110CSubset_Loop2100C_Obj As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110C, Edi.Dom.Transactions.Transaction270.Loops.Loop2110)
			Private ReadOnly Property Loop2110C_Obj_Loop2100C_Obj As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110C, Edi.Dom.Transactions.Transaction270.Loops.Loop2110) Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C.Loop2110C
				Get
					If Loop2110CSubset_Loop2100C_Obj Is Nothing Then
						Loop2110CSubset_Loop2100C_Obj = New LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110C, Edi.Dom.Transactions.Transaction270.Loops.Loop2110)(Children(12), 99, "4", "1300")
					End If

					Return Loop2110CSubset_Loop2100C_Obj
				End Get
			End Property
			Private Loop2110DSubset_Loop2100D_Obj As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110D, Edi.Dom.Transactions.Transaction270.Loops.Loop2110)
			Private ReadOnly Property Loop2110D_Obj_Loop2100D_Obj As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110D, Edi.Dom.Transactions.Transaction270.Loops.Loop2110) Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D.Loop2110D
				Get
					If Loop2110DSubset_Loop2100D_Obj Is Nothing Then
						Loop2110DSubset_Loop2100D_Obj = New LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110D, Edi.Dom.Transactions.Transaction270.Loops.Loop2110)(Children(12), 99, "5", "1300")
					End If
		...
		Partial Friend Class Loop2110_Obj
			Inherits LoopBase
			Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2110,
														Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110C,
														Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110D
			Friend Sub New()
				MyBase.New

				Children.AddRange({CType(Nothing, Edi.Dom.Segments.EQ_Obj),
																	New SegmentContainer(Of Edi.Dom.Segments.AMT)(2, "2", "1350"),
																	CType(Nothing, Edi.Dom.Segments.VEH_Obj),
																	CType(Nothing, Edi.Dom.Segments.PDR_Obj),
																	CType(Nothing, Edi.Dom.Segments.PDP_Obj),
																	New SegmentContainer(Of Edi.Dom.Segments.III)(10, "2", "1700"),
																	CType(Nothing, Edi.Dom.Segments.REF_Obj),
																	New SegmentContainer(Of Edi.Dom.Segments.DTP)(9, "2", "2000")})
			...
			Private Sub PopulateSegment(ByVal args As ReaderArgs)
				...
				If String.Compare(SegmentName, "EQ", StringComparison.OrdinalIgnoreCase) = 0 Then
					Seg = Edi.Dom.Segments.EQ_Obj.FromGenericSegment(args.DataSegment, args.Reader.Reader)
					EQ_Obj = Seg
			...
			End Function
			Friend Property EQ_Obj As Edi.Dom.Segments.EQ_Obj
				Get
					Return CType(Children(0), Edi.Dom.Segments.EQ_Obj)
				End Get
				Set(value As Edi.Dom.Segments.EQ_Obj)
					Children(0) = value
				End Set
			End Property

			Private Property EQ_Std As Edi.Dom.Segments.EQ Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2110.EQ
				Get
					Return CType(Children(0), Edi.Dom.Segments.EQ_Obj)
				End Get
				Set(value As Edi.Dom.Segments.EQ)
					Children(0) = value
				End Set
			End Property

			Private Property EQ_IFace_Loop2110C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.EQ Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110C.EQ
				Get
					Return CType(Children(0), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.EQ)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.EQ)
					Children(0) = value
				End Set
			End Property
			Private Property EQ_IFace_1_Loop2110D_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.EQ Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110D.EQ
				Get
					Return CType(Children(0), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.EQ)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.EQ)
					Children(0) = value
				End Set
			End Property
			Friend ReadOnly Property AMT_Obj As SegmentContainer(Of Edi.Dom.Segments.AMT) Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2110.AMT
				Get
					Return CType(Children(1), SegmentContainer(Of Edi.Dom.Segments.AMT))
				End Get
			End Property

			Private AMTSubset_Loop2110C_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.AMT, Edi.Dom.Segments.AMT)
			Private Property AMT_IFace_Loop2110C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.AMT Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110C.AMT
				Get
					If AMTSubset_Loop2110C_Obj Is Nothing Then
						AMTSubset_Loop2110C_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.AMT, Edi.Dom.Segments.AMT)(Children(1), 1, "4", "1350")
					End If
					...
					End If
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.AMT)
					If AMTSubset_Loop2110C_Obj Is Nothing Then
						AMTSubset_Loop2110C_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.AMT, Edi.Dom.Segments.AMT)(Children(1), 1, "4", "1350")
					End If
				...
				End Set
			End Property
			Private AMT_1Subset_Loop2110C_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.AMT_1, Edi.Dom.Segments.AMT)
			Private Property AMT_IFace_1_Loop2110C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.AMT_1 Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110C.AMT_1
				Get
					If AMT_1Subset_Loop2110C_Obj Is Nothing Then
						AMT_1Subset_Loop2110C_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.AMT_1, Edi.Dom.Segments.AMT)(Children(1), 1, "4", "1355")
					End If
					...
					End If
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.AMT_1)
					If AMT_1Subset_Loop2110C_Obj Is Nothing Then
						AMT_1Subset_Loop2110C_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.AMT_1, Edi.Dom.Segments.AMT)(Children(1), 1, "4", "1355")
					End If
			...
			Friend Property VEH_Obj As Edi.Dom.Segments.VEH_Obj
				Get
					Return CType(Children(2), Edi.Dom.Segments.VEH_Obj)
				End Get
			...
			Private Property VEH_Std As Edi.Dom.Segments.VEH Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2110.VEH
				Get
					Return CType(Children(2), Edi.Dom.Segments.VEH_Obj)
				End Get
			...
			Friend Property PDR_Obj As Edi.Dom.Segments.PDR_Obj
				Get
					Return CType(Children(3), Edi.Dom.Segments.PDR_Obj)
				End Get
			...
			Private Property PDR_Std As Edi.Dom.Segments.PDR Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2110.PDR
				Get
					Return CType(Children(3), Edi.Dom.Segments.PDR_Obj)
				End Get
			...
			Friend Property PDP_Obj As Edi.Dom.Segments.PDP_Obj
				Get
					Return CType(Children(4), Edi.Dom.Segments.PDP_Obj)
				End Get
			...
			Private Property PDP_Std As Edi.Dom.Segments.PDP Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2110.PDP
				Get
					Return CType(Children(4), Edi.Dom.Segments.PDP_Obj)
				End Get
			...
			Friend ReadOnly Property III_Obj As SegmentContainer(Of Edi.Dom.Segments.III) Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2110.III
				Get
					Return CType(Children(5), SegmentContainer(Of Edi.Dom.Segments.III))
				End Get
			End Property

			Private IIISubset_Loop2110C_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.III, Edi.Dom.Segments.III)
			Private Property III_IFace_Loop2110C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.III Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110C.III
				Get
					If IIISubset_Loop2110C_Obj Is Nothing Then
						IIISubset_Loop2110C_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.III, Edi.Dom.Segments.III)(Children(5), 1, "4", "1390")
					End If
					...
					End If
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.III)
					If IIISubset_Loop2110C_Obj Is Nothing Then
						IIISubset_Loop2110C_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.III, Edi.Dom.Segments.III)(Children(5), 1, "4", "1390")
					End If
				...
				End Set
			End Property
			Private IIISubset_1_Loop2110D_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.III, Edi.Dom.Segments.III)
			Private Property III_IFace_1_Loop2110D_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.III Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110D.III
				Get
					If IIISubset_1_Loop2110D_Obj Is Nothing Then
						IIISubset_1_Loop2110D_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.III, Edi.Dom.Segments.III)(Children(5), 1, "5", "1390")
					End If
					...
					End If
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.III)
					If IIISubset_1_Loop2110D_Obj Is Nothing Then
						IIISubset_1_Loop2110D_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.III, Edi.Dom.Segments.III)(Children(5), 1, "5", "1390")
					End If
			...
			Friend Property REF_Obj As Edi.Dom.Segments.REF_Obj
				Get
					Return CType(Children(6), Edi.Dom.Segments.REF_Obj)
				End Get
			...
			Private Property REF_Std As Edi.Dom.Segments.REF Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2110.REF
				Get
					Return CType(Children(6), Edi.Dom.Segments.REF_Obj)
				End Get
			...
			Private Property REF_IFace_Loop2110C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.REF Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110C.REF
				Get
					Return CType(Children(6), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.REF)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.REF)
					Children(6) = value
				End Set
			End Property
			Private Property REF_IFace_1_Loop2110D_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.REF Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110D.REF
				Get
					Return CType(Children(6), Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.REF)
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.REF)
					Children(6) = value
				End Set
			End Property
			Friend ReadOnly Property DTP_Obj As SegmentContainer(Of Edi.Dom.Segments.DTP) Implements Edi.Dom.Transactions.Transaction270.Loops.Loop2110.DTP
				Get
					Return CType(Children(7), SegmentContainer(Of Edi.Dom.Segments.DTP))
				End Get
			End Property

			Private DTPSubset_Loop2110C_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.DTP, Edi.Dom.Segments.DTP)
			Private Property DTP_IFace_Loop2110C_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.DTP Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110C.DTP
				Get
					If DTPSubset_Loop2110C_Obj Is Nothing Then
						DTPSubset_Loop2110C_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.DTP, Edi.Dom.Segments.DTP)(Children(7), 1, "4", "1500")
					End If
					...
					End If
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.DTP)
					If DTPSubset_Loop2110C_Obj Is Nothing Then
						DTPSubset_Loop2110C_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.DTP, Edi.Dom.Segments.DTP)(Children(7), 1, "4", "1500")
					End If
				...
				End Set
			End Property
			Private DTPSubset_1_Loop2110D_Obj As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.DTP, Edi.Dom.Segments.DTP)
			Private Property DTP_IFace_1_Loop2110D_Obj As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.DTP Implements Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110D.DTP
				Get
					If DTPSubset_1_Loop2110D_Obj Is Nothing Then
						DTPSubset_1_Loop2110D_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.DTP, Edi.Dom.Segments.DTP)(Children(7), 1, "5", "1500")
					End If
					...
					End If
				End Get
				Set(value As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.DTP)
					If DTPSubset_1_Loop2110D_Obj Is Nothing Then
						DTPSubset_1_Loop2110D_Obj = New SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.DTP, Edi.Dom.Segments.DTP)(Children(7), 1, "5", "1500")
					End If
		...
		Public Interface Standard
			...
			ReadOnly Property Loop2000 As LoopContainer(Of Edi.Dom.Transactions.Transaction270.Loops.Loop2000)
		...
		Namespace Loops
			...
			Public Interface Loop2000
				...
				ReadOnly Property Loop2100 As LoopContainer(Of Edi.Dom.Transactions.Transaction270.Loops.Loop2100)
			End Interface
			'''<summary></summary>
			'''<remarks></remarks>
			Public Interface Loop2100
				...
				ReadOnly Property Loop2110 As LoopContainer(Of Edi.Dom.Transactions.Transaction270.Loops.Loop2110)
			End Interface
			'''<summary></summary>
			'''<remarks></remarks>
			Public Interface Loop2110
				Inherits ILoop
				'''<summary>Eligibility or Benefit Inquiry</summary>
				Property EQ As Edi.Dom.Segments.EQ
				...
				ReadOnly Property III As SegmentContainer(Of Edi.Dom.Segments.III)
				'''<summary>Reference Information</summary>
		...
		Namespace Transaction270_B1
			Namespace Segments
				...
				Namespace Loop2100C
					...
					Public Interface HI
						...
						'''<summary></summary>
						Property HI01 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_01.C022
						'''<summary></summary>
						Property HI02 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_02.C022
						'''<summary></summary>
						Property HI03 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_03.C022
						'''<summary></summary>
						Property HI04 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_04.C022
						'''<summary></summary>
						Property HI05 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_05.C022
						'''<summary></summary>
						Property HI06 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_06.C022
						'''<summary></summary>
						Property HI07 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_07.C022
						'''<summary></summary>
						Property HI08 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100C.HI.HI_08.C022
					End Interface
				...
				Namespace Loop2110C
					...
					Public Interface EQ
						...
						'''<summary></summary>
						Property EQ05 As Edi.Dom.DataElements.Composite.C004
					End Interface
				...
				Namespace Loop2100D
					...
					Public Interface HI
						...
						'''<summary></summary>
						Property HI01 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_01.C022
						'''<summary></summary>
						Property HI02 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_02.C022
						'''<summary></summary>
						Property HI03 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_03.C022
						'''<summary></summary>
						Property HI04 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_04.C022
						'''<summary></summary>
						Property HI05 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_05.C022
						'''<summary></summary>
						Property HI06 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_06.C022
						'''<summary></summary>
						Property HI07 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_07.C022
						'''<summary></summary>
						Property HI08 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Composites.Loop2100D.HI.HI_08.C022
					End Interface
			...
			Namespace Loops
				...
				Public Interface Loop2000A
					...
					'''<summary>Information Source Level</summary>
					Property HL As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000A.HL

					'''<summary>Information Source Name</summary>
					Property Loop2100A As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100A
				End Interface
				'''<summary>Information Source Name</summary>
				Public Interface Loop2100A
					...
					'''<summary>Information Source Name</summary>
					Property NM1 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100A.NM1
				End Interface
				'''<summary>Information Receiver Level</summary>
				Public Interface Loop2000B
					...
					'''<summary>Information Receiver Level</summary>
					Property HL As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000B.HL

					'''<summary>Information Receiver Name</summary>
					Property Loop2100B As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100B
				End Interface
				'''<summary>Information Receiver Name</summary>
				Public Interface Loop2100B
					...
					'''<summary>Information Receiver Name</summary>
					Property NM1 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.NM1

					'''<summary>Information Receiver Additional Identification</summary>
					ReadOnly Property REF As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.REF, Edi.Dom.Segments.REF)

					'''<summary>Information Receiver Address</summary>
					Property N3 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.N3

					'''<summary>Information Receiver City, State, ZIP Code</summary>
					Property N4 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.N4

					'''<summary>Information Receiver Provider Information</summary>
					Property PRV As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100B.PRV
				End Interface
				'''<summary>Subscriber Level</summary>
				Public Interface Loop2000C
					...
					'''<summary>Subscriber Level</summary>
					Property HL As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000C.HL

					'''<summary>Subscriber Trace Number</summary>
					ReadOnly Property TRN As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000C.TRN, Edi.Dom.Segments.TRN)

					'''<summary>Subscriber Name</summary>
					Property Loop2100C As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100C
				End Interface
				'''<summary>Subscriber Name</summary>
				Public Interface Loop2100C
					...
					'''<summary>Subscriber Name</summary>
					Property NM1 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.NM1

					'''<summary>Subscriber Additional Identification</summary>
					ReadOnly Property REF As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.REF, Edi.Dom.Segments.REF)

					'''<summary>Subscriber Address</summary>
					Property N3 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.N3

					'''<summary>Subscriber City, State, ZIP Code</summary>
					Property N4 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.N4

					'''<summary>Provider Information</summary>
					Property PRV As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.PRV

					'''<summary>Subscriber Demographic Information</summary>
					Property DMG As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.DMG

					'''<summary>Multiple Birth Sequence Number</summary>
					Property INS As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.INS

					'''<summary>Subscriber Health Care Diagnosis Code</summary>
					Property HI As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.HI

					'''<summary>Subscriber Date</summary>
					ReadOnly Property DTP As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100C.DTP, Edi.Dom.Segments.DTP)

					'''<summary>Subscriber Eligibility or Benefit Inquiry</summary>
					ReadOnly Property Loop2110C As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110C, Edi.Dom.Transactions.Transaction270.Loops.Loop2110)
				End Interface
				'''<summary>Subscriber Eligibility or Benefit Inquiry</summary>
				Public Interface Loop2110C
					...
					'''<summary>Subscriber Eligibility or Benefit Inquiry</summary>
					Property EQ As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.EQ

					'''<summary>Subscriber Spend Down Amount</summary>
					Property AMT As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.AMT

					'''<summary>Subscriber Spend Down Total Billed Amount</summary>
					Property AMT_1 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.AMT_1

					'''<summary>Subscriber Eligibility or Benefit Additional Inquiry Information</summary>
					Property III As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.III

					'''<summary>Subscriber Additional Information</summary>
					Property REF As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.REF

					'''<summary>Subscriber Eligibility/Benefit Date</summary>
					Property DTP As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110C.DTP
				End Interface
				'''<summary>Dependent Level</summary>
				Public Interface Loop2000D
					...
					'''<summary>Dependent Level</summary>
					Property HL As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000D.HL

					'''<summary>Dependent Trace Number</summary>
					ReadOnly Property TRN As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2000D.TRN, Edi.Dom.Segments.TRN)

					'''<summary>Dependent Name</summary>
					Property Loop2100D As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2100D
				End Interface
				'''<summary>Dependent Name</summary>
				Public Interface Loop2100D
					...
					'''<summary>Dependent Name</summary>
					Property NM1 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.NM1

					'''<summary>Dependent Additional Identification</summary>
					ReadOnly Property REF As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.REF, Edi.Dom.Segments.REF)

					'''<summary>Dependent Address</summary>
					Property N3 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.N3

					'''<summary>Dependent City, State, ZIP Code</summary>
					Property N4 As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.N4

					'''<summary>Provider Information</summary>
					Property PRV As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.PRV

					'''<summary>Dependent Demographic Information</summary>
					Property DMG As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.DMG

					'''<summary>Dependent Relationship</summary>
					Property INS As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.INS

					'''<summary>Dependent Health Care Diagnosis Code</summary>
					Property HI As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.HI

					'''<summary>Dependent Date</summary>
					ReadOnly Property DTP As SegmentSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2100D.DTP, Edi.Dom.Segments.DTP)

					'''<summary>Dependent Eligibility or Benefit Inquiry</summary>
					ReadOnly Property Loop2110D As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2110D, Edi.Dom.Transactions.Transaction270.Loops.Loop2110)
				End Interface
				'''<summary>Dependent Eligibility or Benefit Inquiry</summary>
				Public Interface Loop2110D
					...
					'''<summary>Dependent Eligibility or Benefit Inquiry</summary>
					Property EQ As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.EQ

					'''<summary>Dependent Eligibility or Benefit Additional Inquiry Information</summary>
					Property III As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.III

					'''<summary>Dependent Additional Information</summary>
					Property REF As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.REF

					'''<summary>Dependent Eligibility/Benefit Date</summary>
					Property DTP As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.Loop2110D.DTP
				End Interface
			...
			Public Interface TransactionSet
				...
				'''<summary>Transaction Set Header</summary>
				Property ST As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.ST

				'''<summary>Beginning of Hierarchical Transaction</summary>
				Property BHT As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.BHT

				'''<summary>Information Source Level</summary>
				ReadOnly Property Loop2000A As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000A, Edi.Dom.Transactions.Transaction270.Loops.Loop2000)

				'''<summary>Information Receiver Level</summary>
				ReadOnly Property Loop2000B As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000B, Edi.Dom.Transactions.Transaction270.Loops.Loop2000)

				'''<summary>Subscriber Level</summary>
				ReadOnly Property Loop2000C As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000C, Edi.Dom.Transactions.Transaction270.Loops.Loop2000)

				'''<summary>Dependent Level</summary>
				ReadOnly Property Loop2000D As LoopSubsetContainer(Of Edi.Dom.Transactions.Transaction270.Transaction270_B1.Loops.Loop2000D, Edi.Dom.Transactions.Transaction270.Loops.Loop2000)

				'''<summary>Transaction Set Trailer</summary>
				Property SE As Edi.Dom.Transactions.Transaction270.Transaction270_B1.Segments.SE
			End Interface
